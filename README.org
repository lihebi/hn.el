...
** TODO export starred articles as a webpage
I'm defining a new data format for the history file.
...
Side effect: if an article gets unstarred, its tag is lost.

Example:

#+BEGIN_EXAMPLE
((20105996 "Title" ("tag1" "tag2" ...))
 (20105996 "Title" ("tag1" "tag2" ...)) ...)
#+END_EXAMPLE
